...
export default {
  ...
  theme: {
    extend: {
      colors: {
        ...
        'light-gray': '#d1d5db',
        'accent': '#22d3ee',
        // Novas cores para gradientes modernos
        'cyan': {
          50: '#ecfeff',
          100: '#cffafe',
          200: '#a5f3fc',
      ...
      boxShadow: {
        ...
        'neon-blue': '0 0 5px theme(colors.blue.400), 0 0 20px theme(colors.blue.400), 0 0 35px theme(colors.blue.400)',
  ...
  plugins: [
    // Plugin para adicionar utilitários de text-shadow
    ...
    // Plugin para animações de gradiente
    function({ addUtilities }) {
      const newUtilities = {
        '.bg-animate': {
          'background-size': '400%',
